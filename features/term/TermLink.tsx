...
type LinkishProps = Omit<LinkProps, 'children' | 'href' | 'style' | 'className'>
type Props = PropsWithChildren<{ to: string; soft?: boolean } & LinkishProps>

const TermLink: React.FC<Props> = ({ children, to, soft, ...linkProps }) => (
	<Link
		{...linkProps}
		href={to}
